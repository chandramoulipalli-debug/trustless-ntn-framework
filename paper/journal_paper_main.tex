...
\begin{enumerate}
  ...
  \item \textbf{First multi-segment, multi-attack quantitative evaluation:}
        ...
        sensitivity across GEO/LEO/HAPS/UAV/Ground node types.
...
zero-FPR condition for all five segments (minimum legitimate:
0.264~UAV; maximum malicious: 0.062~GEO; HAPS: 0.049 and 0.414
...
$\theta^*$ in all segments while bringing malicious trust below
