...
five segments (minimum legitimate: 0.264~UAV; maximum malicious:
0.062~GEO; HAPS: 0.049 and 0.414 respectively; Table~\ref{tab:lambda}).
...
$f\!=\!20\%$ malicious fraction, this corresponds to
$\approx\!213$ legitimate nodes quarantined per round.
...
$k\!=\!4$ for Ground ($L_s\!=\!0.284$;
$\lceil{-4.605}/{-1.258}\rceil\!=\!4$), and
