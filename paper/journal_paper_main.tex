...
UAV-centric approaches~\cite{uav_fl} apply a uniform UAV-class decay
rate to all node types, producing FPR\,=\,27.9\,\%.
...
The approach in~\cite{uav_fl} pairs blockchain with federated learning
for UAV trust but applies uniform $\lambda\!=\!0.05$ to all segment
types, over-penalizing stable GEO nodes (Section~\ref{sec:evaluation}).
...
UAV+FL~\cite{uav_fl}         & FL    & Part. & Unif.  & UAV   & Part. \\
...
Five design principles guide the architecture: elimination of implicit
trust, decentralization by construction, delay and disruption
tolerance, privacy preservation, and continuous verification.
...
\textbf{UAV+FL}~\cite{uav_fl}: federated, uniform $\lambda\!=\!0.05$.
...
to build to $T\!\approx\!0.85$ over 20 rounds, then requires $>35$
rounds to fall below $\theta\!=\!0.20$.
...
\addplot[red, thick, dashed, mark=none] coordinates {
  ...
  (100,0.356)(148,0.356)(150,0.356)
  (151,0.131)(152,0.067)(155,0.043)(160,0.042)
  (200,0.042)(300,0.042)(400,0.042)(499,0.042)
};
\addlegendentry{Proposed (malicious)}
% Static DLT build-then-betray (builds to 0.85, slow decay)
\addplot[orange!90!black, thick, dotted, mark=none] coordinates {
  (0,0.500)(1,0.605)(2,0.679)(3,0.730)(5,0.791)(8,0.830)
  (12,0.845)(20,0.850)(50,0.850)(100,0.850)(148,0.850)(150,0.850)
  (151,0.625)(152,0.468)(155,0.226)(160,0.121)(170,0.101)
  (185,0.100)(200,0.100)(300,0.100)(400,0.100)(499,0.100)
};
\addlegendentry{Static DLT (malicious)}
% Threshold theta*=0.20
...
\node[font=\tiny, gray, rotate=90] at (axis cs:143,0.60)
  {Betrayal onset};
\end{axis}
\end{tikzpicture}
\caption{Trust score trajectories (Ground segment,
         $\alpha\!=\!0.70$, $\lambda_s\!=\!0.015$\,s$^{-1}$,
         $\Delta t\!=\!60$\,s). Proposed model: betrayal detected in
         $\approx$\,5 rounds (drops from 0.356 to 0.042). Static DLT:
         attacker builds to 0.85, requires $>$35 rounds to fall below
         $\theta\!=\!0.20$. Dotted green: $\theta^*\!=\!0.20$.}
\label{fig:trust_evo}
\end{figure}
...
\bibitem{uav_fl}
M.~Kamal, I.~Rashid, W.~Iqbal, M.~H.~Siddiqui, S.~Khan, and I.~Ahmad,
...
in \textit{Proc. [Conference Name]}, 2026, Paper no.~2026004467.
